# functions for cropping pedestrians and non-pedestrians in D4
# Note: json files in D4 is very big, 1G
...
def get_nonPed_examples(json_path, nonPed_txt):
    ...
    with open(json_path) as f:
        for record in tqdm(ijson.items(f, "item")):
            nonPed_flag = True
            timeofday = record['attributes']['timeofday']
            ...
            if nonPed_flag:
                nonPed_num += 1
                nonPed_list.append([record['name'], timeofday])
    ...
    with open(nonPed_txt, 'w') as f:
        for item in nonPed_list:
            name = item[0]
            timeofday = item[1]
            msg = os.path.join('', name) + ' ' + timeofday + '\n'
            f.write(msg)


# json_path = r'D:\my_phd\dataset\D4_BDD\bdd100k\labels\bdd100k_labels_images_train.json'
# nonPed_txt = r'D:\my_phd\dataset\D4_BDD\nonPed.txt'
...
# nonPed_txt = r'D:\my_phd\dataset\D4_BDD\nonPed.txt'
# image_dir = r'D:\my_phd\dataset\D4_BDD\bdd100k\images\100k'
# save_to = r'D:\my_phd\dataset\D4_BDD\nonPedestrian'
...
# # 划分 non pedestrian
# image_dir = r'D:\my_phd\dataset\D4_BDD100K\nonPedestrian'
# txt_dir = r'D:\my_phd\dataset\D4_BDD100K\dataset_txt'
# split_dataset(image_dir, txt_dir, 'nonPedestrian', '0')
#
# # 划分 pedestrian
# image_dir = r'D:\my_phd\dataset\D4_BDD100K\pedestrian'
# txt_dir = r'D:\my_phd\dataset\D4_BDD100K\dataset_txt'
